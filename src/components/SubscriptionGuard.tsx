...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'keterangan-kerja'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'keterangan-kerja') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'keterangan-kerja'): boolean => {
    try {
